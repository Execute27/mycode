...
def main():
    ...
    # Green  White and Blue text
    #print('{} white {}'.format(crayons.green('green'), crayons.blue('blue'))) # format string (old ver of str templating)
    print(f"{crayons.green('green')} white {crayons.blue('blue')}")  # f-string (newest version of str templating)
